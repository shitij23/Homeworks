...
// THE FOLLOWING FUNCTIONS WERE ONLY DEFINED IN THE MAIN.C FILES IN HW 4 AND 5
// FOR MODULARITY ALL THE FOLLOWING FUNCTIONS ARE NOW DECLARED UNDER I2C_DISPLAY
...
void display_message(char *message, int xo, int yo){
    int i=0;
    while (message[i]){
        display_letter((int)message[i]-0x20,xo,yo+i*6);
        i++;
    }
